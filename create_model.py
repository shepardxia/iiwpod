...
class head(nn.Module):
    def __init__(self, ):
        ...
        #self.batch_1 = nn.BatchNorm2d(16, )
        #self.relu_1 = nn.ReLU()
        self.conv_2 = nn.Conv2d(64, 16, (3, 3))
        #self.lin_1 = nn.Linear(16, 16)
        self.conv_3 = nn.Conv2d(16, 1, (1, 1))
        self.sig_1 = nn.Sigmoid()
        
        #self.conv_4 = nn.Conv2d()
        #self.batch_2 = nn.BatchNorm2d()
        #self.relu_2 = nn.ReLU()
        self.conv_5 = nn.Conv2d(64, 16, (3, 3))
        #self.lin_2 = nn.Linear(16, 16)
        self.conv_6 = nn.Conv2d(16, 6, (1, 1))
